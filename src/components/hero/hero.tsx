    ...
    <section className="w-full flex flex-col xl:flex-row justify-center xl:justify-between items-center px-4 md:px-8 lg:px-16 xl:pr-32 py-8 gap-8 xl:gap-16 xl:h-full">
      <div className="flex flex-col items-start gap-4 md:gap-6 lg:gap-8 w-full lg:max-w-xl">
        ...
        <button
          ...
          className="w-full md:w-auto bg-[#AA3EEE] hover:bg-[#9B2EDE] hover:translate-y-0.5 hover:opacity-60 text-white uppercase font-semibold px-6 pt-4 pb-[calc(18px-2px)] rounded-lg cursor-pointer transition-all duration-200 border-b-2 border-[#6500A4]"
        >
          Access with X
        </button>
      </div>
